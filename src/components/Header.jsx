...
function Header(){
    ...
    return <div className="flex flex-col-reverse lg:flex-row items-center justify-evenly relative  p-5 pt-20 bg-opacity-20" style={{backgroundImage:'linear-gradient(#caf452,white,transparent)'}}>
        ...
        <img src={draw}  alt="no pic" className="right-[90px] w-[470px] top-28 z-[5] drop-shadow-xl absolute  drop-shadow-black " />
        ...
        <img src={book} alt="" data-aos='slide-left' className="absolute z-[10] top-[120px] right-[120px] w-[130px]"/>
