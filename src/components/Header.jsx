...
function Header(){
    ...
    return <div className="flex flex-col-reverse lg:flex-row items-center justify-evenly relative  p-5 pt-20 bg-opacity-20" style={{backgroundImage:'linear-gradient(#63F2E2,white,transparent)'}}>
        <div className=" z-10 p-[20px] relative align-middle justify-center">
        <img src={exbook} alt="" data-aos='slide-right' className="absolute z-[-10] top-[230px] left-[270px] w-[130px]"/>
        ...
        <img src={draw}  alt="no pic" data-aos='fade-down' className="right-[90px] w-[340px] sm:w-[470px] top-28 z-[5] drop-shadow-xl absolute  drop-shadow-black " />
            <svg className=" w-[500px] sm:w-[600px] right-[20px] " viewBox="0 0 200 200" xmlns="http://www.w3.org/2000/svg">
        ...
        <img src={book} alt="" data-aos='slide-left' className="absolute z-[10] sm:top-[120px] sm:right-[120px] top-[70px] right-[70px] w-[130px]"/>
        <img src={search} alt="" data-aos='slide-left' className="absolute z-[10] bottom-[110px] right-[330px] w-[150px]"/>
        </div>
    </div>
}
